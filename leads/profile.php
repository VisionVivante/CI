   ...
   <div class="row">
      ...
      <div class="lead-edit<?php if(isset($lead)){echo ' hide';} ?>">
         ...
         <hr class="no-mtop mbot15" />
          <div class="col-md-12">
            <?php $value = (isset($lead) ? $lead->jobtitle : ''); ?>
            <?php echo render_input('jobtitle','Job Title',$value); ?>
            <?php $value = (isset($lead) ? $lead->joburl : ''); ?>
            <?php echo render_input('joburl','Job Url',$value); ?>
            <?php $value = (isset($lead) ? $lead->bidurl : ''); ?>
            <?php echo render_input('bidurl','Application Url',$value); ?>
         </div>
         <div class="col-md-6">
         ...
         <div class="col-md-12">
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="lead-select-date-contacted col-md-6 ">
                       <?php echo render_datetime_input('leaddate','leaddate','',array('data-date-end-date'=>date('Y-m-d'))); ?>
                    </div>
                    <div class="lead-select-date-contacted col-md-6 ">
